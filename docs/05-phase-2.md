...
Labels never cross the text column. Where the page is a vertical stack the whole set stands down, since the globe sits behind the prose there rather than beside it. Where it is beside a column but narrow, individual names that would reach into the measure hide instead: 12 of 12 shown at 1440×900, 11 at 1280×720, 6 at 1024×768, 1 at 844×390, none at 900×700 or 390×844, and none at any size drawn over the article.
