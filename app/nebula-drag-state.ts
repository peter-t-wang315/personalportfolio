...
export const RADIANS_PER_PX = 0.006;
...
/*
 * The outside turn — how a portrait phone spins the globe on `/nebula` —
 * lives in nebula-outside-turn.ts. It is a quaternion now, and that needs
 * `three`, which this module is kept free of.
 */
