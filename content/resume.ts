...
export const resumeExperience: ResumeExperience[] = [
  {
    ...
    bullets: [
      ...
      'Sole developer of the React/MUI client for a preventive maintenance platform, caching 10k+ ID-linked records in Jotai for instant local editing and multi-level revert; used by 30%+ of manufacturing',
      'Directed schema and API design behind it, rolling out org-wide: four-level many-to-many hierarchy with frequency scheduling and immutable execution records',
  ...
  },
  {
    ...
    bullets: [
      'Shipped ZENTRA webpages and components with React and Material UI, used by 90%+ of users',
